...
function renderCircles(circlesGroup, newXScale, chosenXaxis, healthdata) {
...
function updateToolTip(chosenXAxis, circlesGroup) {
  ...
  var toolTip = d3.tip()
    ...
    .html(function (d) {
      ...
      return (`${d.state} <br> ${d[chosenXAxis]} <br> ${d.income}`)
    });
...
healthdata.forEach(function (data) {
 ...
 .on("click", function() {
   ...
   if (value !== chosenXAxis) {
     ...
     circlesGroup = renderCircles(circlesGroup, xLinearScale, chosenXAxis, healthdata);
